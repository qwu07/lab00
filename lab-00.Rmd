...
```{r setup-tibble}
team_data <- tibble(
  name = c("Queency", "Jasmine", "Esther", 
           "Amanda", "Eason"),
  github_username = c("qwu07", "Mocha0927", "esterJjjj", 
                      "amanda21-liu", "YichengJin"), 
  colour = c("powderblue", "pink", "white", 
             "pink", "orange"),
  hobby = c("Art", "Video games", "Sports", 
            "Sleep", "Music"),
  favourite_number = c(7, 1, 3, 6, 8)
  )
